...
var idex_sdk_1 = require("@idexio/idex-sdk");
var webSocketClient = new idex_sdk_1.WebSocketClient({
...
*/
var client = new idex_sdk_1.OrderBookRealTimeClient({
    multiverseChain: 'matic',
    sandbox: false,
    apiKey: process.env.IDEX_API_KEY
});
var markets = ['IDEX-USD'];
client.start(markets);
function handleOrderBook(l2) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.getOrderBookL2('IDEX-USD', 10)];
                case 1:
                    l2 = _a.sent();
                    return [2 /*return*/];
            }
